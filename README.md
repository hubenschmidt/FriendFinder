...
The TasteMaker application is an app for making friends based on music taste. This full-stack site takes in user survey responses, then compares the answers to other surveyed users. The app will then display the name and picture of the user with the best match.
